...
export { DEFAULT_CHUNK_MAX_CHARACTERS, chunkDocNode } from './core/chunker.js';
export { estimateTokenCount } from './utils/text-metrics.js';
export type {
  ChunkDocNodeOptions,
  ChunkDocNodeResult,
  SemanticChunk,
...
} from './core/source-verification.js';
export type {
  SourceVerificationComparison,
  SourceVerificationDocsFileEvidence,
  SourceVerificationDocsFileStatus,
  SourceVerificationDocsInspection,
  SourceVerificationDocsReference,
  SourceVerificationDocsReferenceKind,
  SourceVerificationDocsSkipReason,
  SourceVerificationDocsTraversalSettings,
  SourceVerificationFailure,
  SourceVerificationFailureReason,
  SourceVerificationGeneratedOutput,
  SourceVerificationGeneratorMetadata,
  SourceVerificationInputType,
  SourceVerificationManifest,
  SourceVerificationObservedExport,
  SourceVerificationReferenceClassification,
  SourceVerificationReferenceMatch,
  SourceVerificationReport,
  SourceVerificationResult,
  SourceVerificationSourceFactReference,
  SourceVerificationSummary,
  SourceVerificationUnmatchedReference,
  VerifyDocsAgainstSourceOptions,
} from './core/source-verification.js';
export {
  SOURCE_DOCS_MODE,
