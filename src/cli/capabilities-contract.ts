  ...
  implemented: [
    ...
    },
    {
      ...
      limitations: [
        ...
        'input provenance summaries are content-free manifest metadata only',
        'artifact summaries are content-free manifest metadata only',
        'git provenance, --label, --exclude, skipped-file, and draft-file entries are recorded facts only; the CLI records provenance and never selects, excludes by judgment, or verifies source truth',
        'draft-like source files are reported, never auto-excluded',
        'no URL fetching',
